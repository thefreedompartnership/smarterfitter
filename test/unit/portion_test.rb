...
class PortionTest < Test::Unit::TestCase
  ...
  def test_portion_rounding
    portion = Portion.new(foods(:butter), foods(:butter).weights[3], BigDecimal.new("1"))
